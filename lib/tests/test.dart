  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          print(BlocProvider.of<EducationBloc>(context)
              .state
              .model[1]
              .university.text);
              print(BlocProvider.of<EducationBloc>(context)
  ...
  Widget build(BuildContext context) {
    return Scaffold(body:
      ...
      return Center(child: Text(
          // "name: ${context.watch<EducationBloc>().state.EducationModel.fullName.text}, job: ${context.watch<EducationBloc>().state.EducationModel.jobTitle.text}, date: ${context.watch<EducationBloc>().state.EducationModel.date.text}, length: ${context.watch<EducationBloc>().state.EducationModel.listUrl.length}"));
          BlocProvider.of<EducationBloc>(context).state.model.length.toString()));
    })));
  }
}
